...
class Farm(models.Model):
    ...
    billing_rate_override = models.DecimalField(decimal_places=2, max_digits=10, default=0.00)
...
class Trips(models.Model):
    ...
    driver_additional_remarks = models.CharField(max_length=100, blank=True, null=True, default="N/A")
    ...
    current_billing_rate =  models.DecimalField(decimal_places=2, max_digits=10, default=0.00)
    ...
    additional_expense_remark = models.CharField(max_length=100, blank=True, null=True, default="N/A")
    rate_adjustment = models.DecimalField(decimal_places=2, max_digits=10, default=0.00)
    management_remarks = models.CharField(max_length=100, blank=True, null=True, default="N/A")
